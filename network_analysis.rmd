...
angles <- c(43, 100, 110, 118, 135, 190, 315, 0)
...
ggraph(layout) +
  ...
  labs(
    ...
    caption = 'Data provided by the RGK Center | Plot by Ethan Tenison'
  ) +
    geom_node_text(#American youthworks changed to youthworks, Texas Homeless Network to THN, Literacy Coalition of Central Texas changed to Literacy Coalition, Workforce Solutions - Capital Area Workforce Board changed to workforce solutions 
     aes(
       x = 1.0175 * x,
       y = 1.0175 * y,
       label = ifelse(
     ...
     size = 3, hjust = 'outward', family = 'Georgia'
   ) +
  geom_node_text(
    aes(
      x = x,
    ...
    size = 3, hjust = 0.5, family = 'Georgia'
  ) +
  geom_node_text(
    aes(
      x = x,
  ...
  theme(
    ...
    plot.caption = element_text(
      face = 'plain', color = '#000000', size = 10, hjust = 1,
      margin = margin(b = 20)
    ),
