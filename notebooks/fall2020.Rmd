...
org_learning <- read_csv("data/external/organization_learning.csv", 
...
org_learning$percent <- org_learning$n/9
...
#Quesiton
org_learning$Question[org_learning$Question == "implement a measurement strategy for program evaluation"] <- "implement a measurement\n strategy for program evaluation"

org_learning$Question[org_learning$Question == "conduct surveys, focus groups, or stakeholder interviews"] <- "conduct surveys, focus groups,\n or stakeholder interviews"

org_learning$Question[org_learning$Question == "use data for analysis, visualization, or reporting"] <- "use data for analysis,\n visualization, or reporting"

org_learning$Question[org_learning$Question == "integrate advanced analytics into the organization's operations"] <- "integrate advanced analytics \ninto the organization's operations"

org_learning$Quesiton <- factor(
  org_learning$Question,
  levels =
    c("implement a measurement\n strategy for program evaluation", "conduct surveys, focus groups,\n or stakeholder interviews", "use data for analysis,\n visualization, or reporting", "integrate advanced analytics \ninto the organization's operations"),
  exclude = NULL,
  ordered = TRUE
)
